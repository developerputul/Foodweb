            ...
            <div class="card-body p-4">
                ...
                <div class="row">
                    ...
                    <div class="form-check mb-3">
                        <input class="form-check-input" name="best_seller" type="checkbox" id="formCheck1" value="1">
                        <label class="form-check-label" for="formCheck1">Best Seller</label>
                    </div>

                    <div class="form-check mb-3">
                        <input class="form-check-input" name="most_popular" type="checkbox" id="formCheck1" value="1">
