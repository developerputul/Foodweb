                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div>
                            <div class="form-group mb-3">
                                ...
                                <input class="form-control" name="menu_name" value="{{ $menu->menu_name }}" type="text" id="example-text-input">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                        <div class="mt-3 mt-lg-0">
                            ...
                            <div class="form-group mb-3">
                                <label for="example-date-input" class="form-label">Menu Image</label>
                                <input class="form-control" value="{{ $menu->image }}" name="image" type="file" id="image">
                            </div>
