           ...
           <form method="POST" action="{{ route('register') }}">
             @csrf
                    ...
                    <div class="form-label-group">
                        <input type="text" id="ptext" name="name" class="form-control" placeholder="Type Name">
                    ...
                    <div class="form-label-group">
                        <input type="password" id="inputPassword" name="password" class="form-control" placeholder="Email Address">
                        <label for="inputPassword">Password</label>
                    </div>

                    <div class="form-label-group">
                        <input type="password" id="inputPassword1" name="password_confirmation" class="form-control" placeholder="Password">
                    ...
                    <div class="text-center pt-3">
                        Don’t have an account? <a class="font-weight-bold" href="{{ route('register') }}">Sing Up</a>
                    </div>
            </form>
